    ...
    return (
        <InputGroup size='md'>
            ...
            <InputRightElement width='17rem'>
                <Button h='1.75rem' size='sm' marginRight={2} className={(!tasks.find(item => item.name.toLowerCase().includes(newTask.name.toLowerCase())) || !newTask.name === '' ? '' : 'not-active')} onClick={handleClickAdd}>Add</Button>
